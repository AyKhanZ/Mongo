...
import UploadImageNews from "@/components/UploadImageNews/UploadImageNews";
        ...
        <div className={styles.products}>
          <div className={styles.containerTitle}>
            ...
            <div className={styles.btns}>
              <CreateBtn
                onClick={() => edit(router.query.editId?.toString() ?? "")}
                symbol={pencil}
                title="Edit"
              />
              <CreateBtn
          ...
          <div className={styles.form}>
            ...
            <div className={styles.imageContainer}>
              ...
              <UploadImageNews setImg={setImageFile} img={img} />
            </div>
          </div>
        </div>
      </div>
